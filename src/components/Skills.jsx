    ...
    return (
        <>
            <div className="container mx-auto">
                <h2 className='text-center mt-6 text-indigo-500 text-3xl md:text-5xl  font-bold mb-6'>Technologies & Skills</h2>

                <p className="text-center mt-2 text-gray-500">
                   
"Adaptability in rapidly evolving technology and continuous learning are essential skills for navigating the digital landscape."
                </p>
                <div className="md:flex">
                    <div className="w-full md:w-6/12 lg:w-6/12 p-2 mt-4">
     ...
     L 99.5,0.5" stroke-linecap="round" stroke="#FF6464" stroke-width="1" fill-opacity="0"
                                    style={{ strokeDasharray: "79.2px 100px", strokeDashoffset: "0px", transition: "stroke-dashoffset 0.3s ease 0s", strokeDasharray: "0.3s ease 0s", stroke: "0.3s linear 0s 0.06s" }}>
                                </path>
                            </svg>
                        </div>
                        ...
                        <div className="mb-7">
                            <div className="flex justify-between py-1">
                                <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Mobile Application </span>
     ...
     L 99.5,0.5" stroke-linecap="round" stroke="#9272D4" stroke-width="1" fill-opacity="0"
                                    style={{ strokeDasharray: "94.04px 100px", strokeDashoffset: "0px", transition: "stroke-dashoffset 0.3s ease 0s", strokeDasharray: "0.3s ease 0s", stroke: "0.3s linear 0s 0.06s" }}>
                                </path>
                            </svg>
                        </div>
     ...
     L 99.5,0.5" stroke-linecap="round" stroke="#5185D4" stroke-width="1" fill-opacity="0"
                                    style={{ strokeDasharray: "64.35px 100px", strokeDashoffset: "0px", transition: "stroke-dashoffset 0.3s ease 0s", strokeDasharray: "0.3s ease 0s", stroke: "0.3s linear 0s 0.06s" }}
                                >
                                </path>
                            </svg>
                        </div>
                        ...
                        <div className="mb-7">
                            <div className="flex justify-between py-1">
                                <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Django & Python </span>
     ...
     L 99.5,0.5" stroke-linecap="round" stroke="#CA56F2" stroke-width="1" fill-opacity="0"
                                    style={{ strokeDasharray: "74.25px 100px", strokeDashoffset: "0px", transition: "stroke-dashoffset 0.3s ease 0s", strokeDasharray: "0.3s ease 0s", stroke: "0.3s linear 0s 0.06s" }}
                                >
                                </path>
                            </svg>
                        </div>
...
L 99.5,0.5" stroke-linecap="round" stroke="#FF6464" stroke-width="1" fill-opacity="0"
                        ...
                        <div className="mb-7">
                            <div className="flex justify-between py-1">
                                <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Bootstrap & Tailwind css </span>
...
L 99.5,0.5" stroke-linecap="round" stroke="#9272D4" stroke-width="1" fill-opacity="0"
                        ...
                        <div className="mb-7">
                            <div className="flex justify-between py-1">
                                <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">Php & Laravel</span>
                                <span className="text-base font-semibold text-gray-lite pr-5 dark:text-[#A6A6A6]">65%</span>
                            </div>
                            <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
                                <path className="rc-progress-line-trail" d="M 0.5,0.5
...
L 99.5,0.5" stroke-linecap="round" stroke="#5185D4" stroke-width="1" fill-opacity="0"
                        ...
                        <div className="mb-7">
                            <div className="flex justify-between py-1">
                                <span className="text-base text-gray-lite font-semibold dark:text-[#A6A6A6]">MySql Database</span>
                                <span className="text-base font-semibold text-gray-lite pr-5 dark:text-[#A6A6A6]">75%</span>
                            </div>
                            <svg className="rc-progress-line" viewBox="0 0 100 1" preserveAspectRatio="none">
                                <path className="rc-progress-line-trail" d="M 0.5,0.5
